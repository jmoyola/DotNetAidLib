...
namespace DotNetAidLib.Core.Network.Info.Core
{
    ...
    {
        [Description("Unknow")] UNKNOW = 16384,
        ...
        [Description("")] SLIP = 256,
        [Description("")] CSLIP = 257,
        [Description("")] SLIP6 = 258,
        [Description("")] CSLIP6 = 259,

        [Description("       Notional KISS type       ")]
        RSRVD = 260,
        [Description("")] ADAPT = 264,
        [Description("")] ROSE = 270,
