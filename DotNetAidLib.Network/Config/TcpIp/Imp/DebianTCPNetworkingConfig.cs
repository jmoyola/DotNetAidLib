        ...
        public override void Save()
        {
            lock (oLock)
            {
                ...
                try
                {
                    ...
                    EnvironmentHelper.SearchInPath("mv").CmdExecuteSync(_InterfacesFile.FullName + " " + _InterfacesFile.FullName + ".tmp");
                    EnvironmentHelper.SearchInPath("mv").CmdExecuteSync(tmpInterfacesFile.FullName + " " + _InterfacesFile.FullName);
