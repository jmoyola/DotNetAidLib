...
namespace DotNetAidLib.Core.Network.Info.Imp
{
    public class PosixNetworkInterfaceInfo:NetworkInterfaceInfo
    {
        ...
        {
            ifconfigFile.CmdExecuteSync(this.Name + " up");
            ifupFile.CmdExecuteSync("--ignore-errors " + this.Name);
        }

        public override void Disable()
        {
            ifdownFile.CmdExecuteSync("--ignore-errors " + this.Name);
            ifconfigFile.CmdExecuteSync(this.Name + " down");
        }
