...
namespace DotNetAidLib.Database.SQL.Core
{
	...
	public class LinqToSQLPredicate : ExpressionVisitor
	{
        ...
        private bool assignationExpression = false;

        private Func<MemberInfo, String> _MemberParser = null;
		...
		{
			this._MemberParser = memberParser;
		...
		public String TranslateLambda<T>(Expression<Func<T, bool>> predicate){
			return this.TranslateExpression (predicate);
		}
		...
		protected override Expression VisitBinary(BinaryExpression b)
		{
			...
			case ExpressionType.Equal:
				if (!this.assignationExpression && IsNullConstant(b.Right))
				{
					sb.Append(" IS ");
				}
				else
