...
namespace DotNetAidLib.Database.Export
{
    ...
    {
        private static readonly IList<DataExportDriver> plugins;
        ...
        public static void Export(Stream output, IDictionary<string, object> parameters,
            DataExportCommand dataExportCommand)
        {
            ...
            try
            {
                var dbProviderConnector =
                    new DBProviderConnector(dataExportCommand.DbProvider, dataExportCommand.ConnectionString);
        ...
        public static void Export(Stream output, string outputFormat, IDictionary<string, object> parameters,
            DBProviderConnector dbProviderConnector, string sqlCommand)
        {
            Assert.NotNull(output, nameof(output));
            ...
            try
            {
                var dataExportDriver = plugins.FirstOrDefault(v =>
