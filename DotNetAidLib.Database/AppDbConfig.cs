...
namespace DotNetAidLib
{
    public class AppDbConfig
    {
        ...
        private DBProviderConnector _dbConnector;
        ...
        private AppDbConfig (DBProviderConnector dbConnector)
            :this(dbConnector, "_AppDbConfig", "_Key", "_Value") {}

        private AppDbConfig (DBProviderConnector dbConnector, String configTableName = "_AppDbConfig", String keyColumnName = "_Key", String valueColumnName = "_Value"){
        ...
        public DBProviderConnector DbConnection { get => this._dbConnector; }
        ...
        protected void CreateConfig () {
            try {
                this._dbConnector.CreateConnection()
                .CreateCommand ()
        ...
        {
            return this._dbConnector.CreateConnection()
            .CreateCommand ()
                .AddParameter ("@key", key)
        ...
        {
            DBNullable<String> v = this._dbConnector.CreateConnection()
                .CreateCommand ()
                    .AddParameter ("@key", key)
        ...
        */
        ...
        public static AppDbConfig Instance (DBProviderConnector dbConnector, String instanceName, String configTableName = "_AppDbConfig", String keyColumnName = "_Key", String valueColumnName = "_Value")
        {
            Assert.NotNullOrEmpty ( instanceName, nameof(instanceName));

            if (!instances.ContainsKey (instanceName))
                instances.Add (instanceName, new AppDbConfig (dbConnector, configTableName, keyColumnName, valueColumnName));
