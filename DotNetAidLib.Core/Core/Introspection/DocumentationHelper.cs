...
namespace DotNetAidLib.Core.Introspection
{
    public static class DocumentationHelper
    {
        ...
        private static XmlElement XmlFromName(this Type type, char prefix, string name)
        {
            ...
            var matchedElement =
                xmlDocument["doc"]["members"].SelectSingleNode("member[@name='" + fullName + "']") as XmlElement;
        ...
        {
            if (FailCache.ContainsKey(assembly)) throw FailCache[assembly];
        ...
        private static XmlDocument XmlFromAssemblyNonCached(Assembly assembly)
        {
            ...
            if (assemblyFilename.StartsWith(prefix, StringComparison.InvariantCulture))
                try
                {
