...
namespace DotNetAidLib.Core.Network.Server.Telnet
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            var read = Console.ReadKey(true).KeyChar;

            do
            {
                if (read == 'b') s.sendMessageToAll(Console.ReadLine());
        ...
        {
            Console.WriteLine("BLOCKED: {0}:{1} at {2}", ep.Address, ep.Port, DateTime.Now);
        }
