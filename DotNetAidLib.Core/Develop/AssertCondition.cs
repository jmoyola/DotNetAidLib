...
namespace DotNetAidLib.Core.Develop
{
    ...
    {
        private Func<Object, bool> assertFunction;
        ...
        {
            return this.assertFunction(value);
        }
        ...
        private static AssertCondition _IsString => new AssertCondition((v) => v==null || v.GetType().Equals(typeof(string)));
        ...
        private static AssertCondition _IsNotEmpty => new AssertCondition((v) => v!=null
                                                                               && v.GetType().IsAssignableFrom(typeof(IList))
                                                                               && ((IList)v).Count>0);
        private static AssertCondition _IsBool => new AssertCondition((v) => v!=null && v.GetType().Equals(typeof(bool)));
        private static AssertCondition _IsDateTime => new AssertCondition((v) => v!=null && v.GetType().Equals(typeof(DateTime)));
