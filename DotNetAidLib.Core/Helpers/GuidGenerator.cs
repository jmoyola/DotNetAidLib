...
namespace DotNetAidLib.Core.Helpers
{
    ...
    public static class GuidGenerator
    {
        ...
        private static DateTimeOffset _lastTimestampForNoDuplicatesGeneration = DateTimeOffset.Now;
        ...
        public static Guid GenerateTimeBasedGuid()
        {
            switch (GuidGeneration)
            {
                case GuidGeneration.Fast:
                    return GenerateTimeBasedGuid(DateTimeOffset.Now, ClockSequenceBytes, NodeBytes);
